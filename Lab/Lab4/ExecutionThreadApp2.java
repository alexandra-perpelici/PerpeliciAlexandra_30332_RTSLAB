...
public class ExecutionThreadApp2 extends Thread{
    ...
    public ExecutionThreadApp2(Integer monitor1,Integer monitor2, int sleep_time,  int activity1_min, int activity1_max,int activity2_min, int activity2_max) {
